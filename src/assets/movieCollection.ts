...
export const movieCollection: Array<Movie> = [
    ...
    },
    {
        ...
        director: "詹姆斯·岡恩",
        year: 2014,
        actors: ["克里斯·普瑞特", "柔伊·莎達娜", "戴夫·巴帝斯塔", "布萊德利·古柏", "馮·迪索", "凱倫·吉蘭", "喬許·布洛林", "Djimon Hounsou"],
        tags: ["漫威", "MCU", "華特迪士尼", "史丹·李"],
        liked: false
    },
    {
    ...
    },
    {
        ...
        director: "Peyton Reed",
        year: 2018,
        actors: ["保羅·路德", "麥克·道格拉斯", "伊凡潔琳·莉莉", "蜜雪兒·菲佛"],
        tags: ["漫威", "MCU", "華特迪士尼", "史丹·李"],
        liked: false
    },
    {
    ...
    },
    {
        ...
        director: "羅素兄弟",
        year: 2019,
        actors: ["小勞勃·道尼", "克里斯·伊凡", "馬克·盧法洛", "克里斯·漢斯沃", "查德威克·鮑斯曼", "布麗·拉森", "伊莉莎白·歐森", "史嘉蕾·喬韓森", "喬許·布洛林", "山繆·傑克森", "黃凱旋", "克里斯·普瑞特", "傑瑞米·雷納", "馮·迪索", "布萊德利·庫柏", "戴夫·巴帝斯塔", "唐·奇鐸", "安東尼·麥基", "保羅·貝特尼", "湯姆·霍蘭德", "班奈狄克·康柏拜區", "保羅·路德", "伊凡潔琳·莉莉",  "葛妮絲·派特洛"],
        tags: ["漫威", "MCU", "華特迪士尼", "史丹·李"],
        liked: false
    },
    {
    ...
    },
    {
        ...
        director: "Jon Watts",
        year: 2021,
        actors: ["湯姆·霍蘭德", "陶比·麥奎爾", "安德魯·加菲爾德", "班奈狄克·康柏拜區", "黃凱旋", "瑪麗莎·托梅", "威廉·達佛", "千黛亞", "強·法夫洛", "雅各布·貝塔隆", "傑米·福克斯", "艾佛烈·蒙利納"],
        tags: ["漫威", "MCU", "索尼影視"],
        liked: false
    },
    {
        ...
        director: "山姆·萊米",
        year: 2022,
        actors: ["班奈狄克·康柏拜區", "伊莉莎白·歐森", "瑞秋·麥亞當斯", "黃凱旋", "霍奇爾·戈梅茲", "奇維托·艾吉佛", "派崔克·史都華", "海莉·艾特沃"],
        tags: ["漫威", "MCU", "華特迪士尼"],
        liked: false
    },
    {
